        ...
        <DialogContent>
          ...
          />
           <DatePicker
            ...
            variant="standard"
            onChange={(value) => {
              setCustomerInfo({ ...customerInfo, birthdate: value.toLocaleDateString("es-AR")})
              console.log( "date del customer" + customerInfo.birthdate)
              }
            }
            format='dd/MM/yyyy'
          />
          <TextField
            required id="cuit" name="cuit" label="CUIT" type="number" fullWidth variant="standard"
